    ...
    >
      ...
      >
        ...
        <div style={{ padding: '15px 20px', background: '#F1F5F9', borderTop: '1px solid #E2E8F0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <input type="file" accept=".json" id="import-file-mod" style={{ display: 'none' }} onChange={handleFileUpload} />
            <label htmlFor="import-file-mod" style={{ cursor: 'pointer', fontSize: '0.85rem', color: '#0284C7', textDecoration: 'underline', marginRight: '15px' }}>
              📥 Import JSON File
            </label>
