    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-['Plus_Jakarta_Sans'] text-left">
      <div className="max-w-md w-full bg-white border border-slate-200 p-8 rounded-3xl space-y-6 shadow-md">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 font-['Outfit']">Welcome Back</h2>
          <p className="text-xs text-slate-600 font-medium">Sign in to access your surprise pages and drafts</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-[11px] text-pink-600 font-bold hover:underline">Forgot?</a>
            </div>
            <div className="relative">
        ...
        <div className="text-center pt-2 border-t border-slate-100">
          ...
          <Link to="/signup" className="text-xs font-bold text-pink-600 hover:underline">Sign up for free</Link>
        </div>
